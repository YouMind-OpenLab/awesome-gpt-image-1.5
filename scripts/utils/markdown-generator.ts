...
function generateGalleryCTA(locale: string): string {
  ...
  const coverImage = `public/images/gpt-image-1-5-cover-${imageLang}.png`;
...
**[${t('browseGallery', locale)}](https://youmind.com/${getLocalePrefix(locale)}/gpt-image-1-5-prompts)**
...
function generatePromptSection(prompt: Prompt, index: number, locale: string): string {
  ...
  md += `**[${t('tryItNow', locale)}](https://youmind.com/${getLocalePrefix(locale)}/gpt-image-1-5?prompt=${encodedPrompt})**\n\n`;
...
function generateAllPromptsSection(regular: Prompt[], hiddenCount: number, locale: string): string {
  ...
  if (hiddenCount > 0) {
    ...
    md += `**[${t('viewAll', locale)}](https://youmind.com/${getLocalePrefix(locale)}/gpt-image-1-5-prompts)**\n\n`;
...
- [🤔 ${t('whatIs', locale)}](#-what-is-gpt-image-15)
...
1. Click [**${t('submitNewPrompt', locale)}**](https://github.com/YouMind-OpenLab/awesome-gpt-image-1.5/issues/new?template=submit-prompt.yml)
2. ${t('fillForm', locale)}
...
**[🌐 ${t('viewInGallery', locale)}](https://youmind.com/${getLocalePrefix(locale)}/gpt-image-1-5-prompts)** •
**[📝 ${t('submitPrompt', locale)}](https://github.com/YouMind-OpenLab/awesome-gpt-image-1.5/issues/new?template=submit-prompt.yml)** •
**[⭐ ${t('starRepo', locale)}](https://github.com/YouMind-OpenLab/awesome-gpt-image-1.5)**
